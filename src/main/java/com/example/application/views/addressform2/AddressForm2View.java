package com.example.application.views.addressform2;
...
@PageTitle("Address Form2")
@Route(value = "address-form2", layout = MainLayout.class)
@PermitAll
public class AddressForm2View extends Div {
    ...
    public AddressForm2View(SampleAddressService addressService) {
        addClassName("address-form2-view");
