...
import com.example.application.views.addressform2.AddressForm2View;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(AddressForm2View.class)) {
            nav.addItem(new SideNavItem("Address Form2", AddressForm2View.class,
